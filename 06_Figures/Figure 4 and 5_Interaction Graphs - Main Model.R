...
# Tree-canopy
colorblindcheck::palette_check(c(viridis(100)[75], 
                                 cividis(100)[50],
                                 rocket(100)[60]), plot = TRUE)

# Cropland
colorblindcheck::palette_check(c(inferno(100)[75], 
                                 cividis(100)[50],
                                 viridis(100)[50]), plot = TRUE)


# Urban
colorblindcheck::palette_check(c(turbo(100)[95], 
                                 cividis(100)[50],
                                 plasma(100)[25]), plot = TRUE)

# Water
colorblindcheck::palette_check(c(mako(100)[40], 
                                 cividis(100)[50],
                                 mako(100)[60]), plot = TRUE)
  ...
  for (j in 1:length(type)) {
    ...
    if(j == 1) { # temp x canopy
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_temp_400m:SLOPE_canopy.mean_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_temp_400m:SLOPE_canopy.mean_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_temp_400m:SLOPE_crop.cci_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_temp_400m:SLOPE_crop.cci_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_temp_400m:SLOPE_urban.gaia_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_temp_400m:SLOPE_urban.gaia_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_temp_400m:SLOPE_water.total_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_temp_400m:SLOPE_water.total_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_precip_400m:SLOPE_canopy.mean_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_precip_400m:SLOPE_canopy.mean_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_precip_400m:SLOPE_crop.cci_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_precip_400m:SLOPE_crop.cci_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_precip_400m:SLOPE_urban.gaia_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_precip_400m:SLOPE_urban.gaia_400m`)
      ...
      interaction.df <- conditional_effects(master,
                                            effects = "SLOPE_precip_400m:SLOPE_water.total_400m")
      interaction.df <- as.data.frame(interaction.df$`SLOPE_precip_400m:SLOPE_water.total_400m`)
    ...
    # metrics
    limits.y <- c(-0.0121, 0.004)
    breaks.y <- c(-0.010, -0.005, 0.000)
    labels.y <- c("-2.28", "-1.14", "0.00")
